...
// Pie
export const pieChartLabels: string[] = ['Download Sales', 'In-Store Sales', 'Mail Sales'];
export const pieChartData: number[] = [300, 500, 100];
export const pieChartType = 'pie';
export const pieChartColors: any[] = [{backgroundColor: ['rgba(0, 157, 160, 0.8)', 'rgba(28, 188, 216, 0.8)', 'rgba(255, 141, 96, 0.8)']}];
